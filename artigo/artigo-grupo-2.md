...
<p> Nosso parceiro, AEL Sistemas, nos trouxe um projeto em que devemos receber um arquivo de altitude, mapear esse arquivo como um grafo e, dado pontos de partida e de saída, traçar uma trajetória que otimize a exposição da aeronave enquanto se mantém na menor altitude possível, ou seja, utilizar do terreno como montanhas para manter a aeronave escondida ao mesmo tempo que a mantemos em uma baixa altitude para não ser reconhecida por radares.</p>
